...
export type AccountingTreatment = 'existing_payable' | 'existing_receivable' | 'expense' | 'customer_advance' | 'internal_transfer' | 'investment_deposit' | 'investment_withdrawal' | 'currency_conversion' | 'fee' | 'already_recorded';
