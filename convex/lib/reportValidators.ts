...
export const reportRowFields = {
  ...
  serviceKind: v.optional(v.union(v.literal('supply'), v.literal('withdraw'), v.literal('conversion'))),
  ...
  kind: v.union(v.literal('payment'), v.literal('fee'), v.literal('deposit'), v.literal('account_transfer'), v.literal('investment'), v.literal('conversion')),
