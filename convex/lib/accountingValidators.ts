...
export const accountingTreatment = v.union(v.literal('existing_payable'), v.literal('existing_receivable'), v.literal('expense'), v.literal('customer_advance'), v.literal('internal_transfer'), v.literal('investment_deposit'), v.literal('investment_withdrawal'), v.literal('fee'), v.literal('already_recorded'));
...
export const accountingFact = v.object({
  ...
  treasuryServiceId: v.optional(v.id('treasuryServices')), lendingMovement: v.optional(v.union(v.literal('supply'), v.literal('withdraw'))),
