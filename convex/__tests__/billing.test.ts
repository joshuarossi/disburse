...
// subscribe requires a server-verified payment row matching
...
describe('Billing', () => {
  describe('get', () => {
    ...
    it('falls back to Free after an expired trial', async () => {
      const t = convexTest(schema);
  ...
  describe('subscribe', () => {
    ...
    it('creates audit log on subscription', async () => {
      ...
      await t.run(async (ctx) => {
        ...
        const subscribeLog = logs.find(
          (l) => l.action === 'billing.subscribed',
        );
  ...
  describe('isActive', () => {
    ...
    it('keeps Free access after an expired trial', async () => {
      const t = convexTest(schema);
    ...
    it('keeps Free access after an expired subscription', async () => {
      const t = convexTest(schema);
    ...
    it('keeps core access when no billing record exists', async () => {
      const t = convexTest(schema);
