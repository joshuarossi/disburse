  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className={compactOnSmallScreens ? 'sr-only md:not-sr-only' : undefined}>{currentTheme.label}</span>
      </Button>
      ...
      {isOpen && (
        <>
          ...
          />
          <div 
            className={cn('absolute right-0 top-full mt-2 z-[60] w-48 rounded-lg border shadow-xl overflow-hidden', compactOnSmallScreens && 'fixed inset-x-4 top-16 w-auto md:absolute md:left-auto md:right-0 md:top-full md:w-48')}
            style={{
