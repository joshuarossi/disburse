...
- Keep new flows translated in every supported locale. Locale checks cover message/variable parity and authored workspace copy; browser checks cover draft preservation and localized workflows. Exercise a real customer export, not only representative CSV fixtures.
